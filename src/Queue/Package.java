...
public class Package {
	...
	/*
	 * Shipping priority determines when this package should be shipped in
	 * relation to the other packages. Packages with higher priority should be
	 * shipped first.
	 * 
	...
	public String toString() {
		return "Package[address=" + this.address + ", shippingPriority="
