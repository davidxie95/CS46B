...
public class Tester {
	public static void main(String[] args) {
		...
		System.out.println("Actual: "
				+ Recursion.reverseStringRecursive("abcde"));
		System.out.println("Expected: edcba");
		System.out.println("Actual: "
				+ Recursion.reverseStringRecursive("amanaplanacanalpanama"));
		System.out.println("Expected: amanaplanacanalpanama");
		System.out.println("Actual: "
				+ Recursion.reverseStringRecursive("bleep bloop"));
		System.out.println("Expected: poolb peelb");

		System.out.println("Actual: "
				+ Recursion.getAllFactorsRecursive(12, 12));
		System.out.println("Expected: [1, 2, 3, 4, 6, 12]");
		System.out.println("Actual: "
				+ Recursion.getAllFactorsRecursive(23, 23));
		System.out.println("Expected: [1, 23]");
		System.out.println("Actual: "
				+ Recursion.getAllFactorsRecursive(76, 76));
